 ...
 * @tree: A pntr to the node to measure the depth of.
 ...
 * @tree: pntr to the root node of the tree to find  leaf in.
 ...
 * @tree: pntr to the root node of the tree to check.
 * Return: tree is NULL or not perfect 0.
 *         else 1.
 */
